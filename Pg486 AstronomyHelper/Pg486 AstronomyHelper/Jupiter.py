...
class Jupiter(Form):
    ...
    def InitializeComponent(self):
        ...
        self._label8.Text = "1.899 * 10^27 kg"
        ...
        self.Load += self.JupiterLoad
        self.ResumeLayout(False)


    def JupiterLoad(self, sender, e):
